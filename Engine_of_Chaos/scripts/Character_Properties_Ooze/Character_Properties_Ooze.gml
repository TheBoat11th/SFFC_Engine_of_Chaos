...
//======================
function Town_Character_Stats_Ooze(_character){
	with(_character){
...
//======================
function Get_Appearance_Ooze(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Ooze_Overworld; 
	var _portrait = spr_Ooze_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Ooze";
...
function Get_Battle_Sprite_Stats_Ooze(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Ooze_Attack; break;
		case "Block": _sprite = spr_Ooze_Block; break;
		case "Cast_Spell": _sprite = spr_Ooze_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Ooze_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Ooze(_object,_stat){
