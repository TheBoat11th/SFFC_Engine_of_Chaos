function Battle_Prop_Stats_AU_Detox_Green_Circle_Intro(_stat){
	var _sprite = spr_AU_Detox_Green_Circle_Intro;
...
function Battle_Prop_Animation_Event_AU_Detox_Green_Circle_Intro(_prop){
	with(_prop){
		if(current_iteration = 2){
			var _this;
			_this = Create_Battle_Cutscene_Prop("AU_Detox_Green_Circle_Loop",_prop.x_pos,_prop.y_pos,0,_prop.mirror,false,false,noone);
