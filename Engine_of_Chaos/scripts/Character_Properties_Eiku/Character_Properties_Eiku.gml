...
//======================
function Town_Character_Stats_Eiku(_character){
	with(_character){
...
//======================
function Get_Appearance_Eiku(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Eiku_GDVL_Overworld; 
	var _portrait = spr_Eiku_GDVL_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Eiku";
...
function Get_Battle_Sprite_Stats_Eiku(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Eiku_Attack; break;
		case "Block": _sprite = spr_Eiku_Block; break;
		case "Cast_Spell": _sprite = spr_Eiku_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Eiku_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Eiku(_object,_stat){
