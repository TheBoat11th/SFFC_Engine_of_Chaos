...
//======================
function Town_Character_Stats_Mishaela(_character){
	with(_character){
...
//======================
function Get_Appearance_Mishaela(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Mishaela_Overworld; 
	var _portrait = spr_Mishaela_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Mishaela";
...
function Get_Battle_Sprite_Stats_Mishaela(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Mishaela_Attack; break;
		case "Block": _sprite = spr_Mishaela_Block; break;
		case "Cast_Spell": _sprite = spr_Mishaela_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Mishaela_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Mishaela(_object,_stat){
