function Town_Character_Stats_AU_Stalagnid(_character){
	with(_character){
		name = "Stalagnid";//Name
...
//======================
function Get_Appearance_AU_Stalagnid(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Stalagnid_Overworld;
	var _portrait = noone;
	var _voice = sfx_Dialogue07;
	var _battle_sprite = "AU_Stalagnid";
...
function Get_Battle_Sprite_Stats_AU_Stalagnid(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_AU_Stalagnid_Attack; break;
		case "Block": _sprite = spr_AU_Stalagnid_Block; break;
