...
//======================
function Town_Character_Stats_Kojirou(_character){
	with(_character){
		Set_Town_Party_Member_Stats(0); 
		can_trigger_room_transition = true; 
		death_flag_script = "Important_Character_0";		
	}
}
...
//======================
function Get_Appearance_Kojirou(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Kojirou_SMRI_Overworld; 
	var _portrait = spr_Kojirou_SMRI_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Kojirou_SMRI";
	...
	switch(Get_Character_Class(_lookup_type,_character,"Abbreviation")){
		case "SMRI": _overworld_sprite = spr_Generic_Chicken_Overworld; break;
	}
	//=====================
...
function Get_Battle_Sprite_Stats_Kojirou_SMRI(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Kojirou_SMRI_Attack; break;
		case "Block": _sprite = spr_Kojirou_SMRI_Block; break;
		case "Use_Item": _sprite = spr_Kojirou_SMRI_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Kojirou_SMRI(_object,_stat){
	...
	//=================
	switch(_sprite){
		case spr_Kojirou_SMRI_Idle:
	        switch(_frame){
	            default: _x_pos = 40; _y_pos = 46; _rotation = 45; break;
	        }
	    break;
	    case spr_Kojirou_SMRI_Attack:
	        switch(_frame){
	            case 1: _x_pos = 19; _y_pos = 61; _rotation = 90; break;
				default:  _x_pos = 68; _y_pos = 29; _rotation = 270; break;
	        }
	    break;
	    case spr_Kojirou_SMRI_Block:
	        switch(_frame){
	            default: _x_pos = 48; _y_pos = 41; _rotation = 315; break;
	        }
	    break;
		case spr_Kojirou_SMRI_Use_Item:
	        switch(_frame){
	            case 1: _x_pos = 66; _y_pos = 43; _rotation = 45; break;
				default:  _x_pos = 60; _y_pos = 48; _rotation = 45; break;
	        }
	    break;
