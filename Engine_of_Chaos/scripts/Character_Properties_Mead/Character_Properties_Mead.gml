...
function Get_Appearance_Mead(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Mead_KNTE_Overworld; 
	var _portrait = spr_Mead_KNTE_Portrait;
	var _voice = sfx_Dialogue06;
	var _battle_sprite = "Mead_KNTE";
...
function Get_Battle_Sprite_Stats_Mead_KNTE(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Mead_KNTE_Attack; break;
		case "Block": _sprite = spr_Mead_KNTE_Block; break;
		case "Ranged_Attack": _sprite = spr_Mead_KNTE_Ranged_Attack; break;
		case "Use_Item": _sprite = spr_Mead_KNTE_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Mead_KNTE(_object,_stat){
