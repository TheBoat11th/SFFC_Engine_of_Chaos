function Control_Config_Event() {
	if(state = "Backed_Out"){//if we are backing out of this menu
	    ...
	    switch (arrow_position + start_index){//set the correct key
			...
			case 8: Swap_Duplicate_Controls("Fast Forward"); global.Fast_Forward = keyboard_lastkey; break; //set Fastforward button to new key
			case 9: Swap_Duplicate_Controls("Full Screen"); global.Full_Screen_Button = keyboard_lastkey; break; //set FullScreen button to new key
	    }
