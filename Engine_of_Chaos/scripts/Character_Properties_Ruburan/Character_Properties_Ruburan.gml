...
//======================
function Town_Character_Stats_Ruburan(_character){
	with(_character){
...
//======================
function Get_Appearance_Ruburan(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Ruburan_THIF_Overworld; 
	var _portrait = spr_Ruburan_THIF_Portrait;
	var _voice = sfx_Dialogue04;
	var _battle_sprite = "Ruburan_THIF";
...
function Get_Battle_Sprite_Stats_Ruburan_THIF(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Ruburan_THIF_Attack; break;
		case "Ranged_Attack": _sprite = spr_Ruburan_THIF_Ranged_Attack; _projectile_type = "Weapon"; break;
		case "Block": _sprite = spr_Ruburan_THIF_Block; break;
		case "Use_Item": _sprite = spr_Ruburan_THIF_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Ruburan_THIF(_object,_stat){
