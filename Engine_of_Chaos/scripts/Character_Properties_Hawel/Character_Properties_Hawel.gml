...
//======================
function Town_Character_Stats_Hawel(_character){
	with(_character){
...
//======================
function Get_Appearance_Hawel(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Hawel_MAGE_Overworld; 
	var _portrait = spr_Hawel_MAGE_Portrait;
	var _voice = sfx_Dialogue04;
	var _battle_sprite = "Hawel_MAGE";
...
function Get_Battle_Sprite_Stats_Hawel_MAGE(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Hawel_MAGE_Attack; break;
		case "Block": _sprite = spr_Hawel_MAGE_Block; break;
		case "Cast_Spell": _sprite = spr_Hawel_MAGE_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Hawel_MAGE_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Hawel_MAGE(_object,_stat){
