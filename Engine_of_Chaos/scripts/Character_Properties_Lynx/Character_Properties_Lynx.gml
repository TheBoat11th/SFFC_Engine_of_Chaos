...
//======================
function Town_Character_Stats_Lynx(_character){
	with(_character){
...
//======================
function Get_Appearance_Lynx(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Lynx_Overworld; 
	var _portrait = spr_Lynx_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Lynx";
...
function Get_Battle_Sprite_Stats_Lynx(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Lynx_Attack; break;
		case "Block": _sprite = spr_Lynx_Block; break;
		case "Cast_Spell": _sprite = spr_Lynx_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Lynx_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Lynx(_object,_stat){
