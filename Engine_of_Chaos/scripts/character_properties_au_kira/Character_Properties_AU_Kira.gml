...
//======================
function Town_Character_Stats_AU_Kira(_character){
	with(_character){
		Set_Town_Party_Member_Stats(3);		
	}
}
...
//======================
function Get_Appearance_AU_Kira(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Kira_THIF_Overworld; 
	var _portrait = spr_AU_Kira_THIF_Portrait;
	var _voice = sfx_Dialogue04;
	var _battle_sprite = "AU_Kira_THIF";
	...
	switch(Get_Character_Class(_lookup_type,_character,"Abbreviation")){
		case "ASSN": _overworld_sprite = spr_Generic_Chicken_Overworld; break;
	}
	//=====================
...
//Battle Sprite Setup
//===================
function Get_Battle_Sprite_Stats_AU_Kira_THIF(_animation,_stat){
	//=============
	//Default Stats (Assume Idle Animation)
	//=============
	var _parent_animation = _animation;
	var _location = "Foreground"; //Foreground or Background
	var _sprite = spr_AU_Kira_THIF_Idle; //Sprite
	var _animation_speed = .0625 / global.xspeed; //Animation Speed
	var _projectile_type = "none"; //Projectile Sprite ("Weapon" uses sprite set via item's script)
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_AU_Kira_THIF_Attack; break;
		case "Ranged_Attack": _sprite = spr_AU_Kira_THIF_Ranged_Attack; _projectile_type = "Weapon"; break;
		case "Block": _sprite = spr_AU_Kira_THIF_Block; break;
		case "Use_Item": _sprite = spr_AU_Kira_THIF_Use_Item; break;
...
//===============================
function Get_Weapon_Position_AU_Kira_THIF(_object,_stat){
	...
	//=================
	switch(_sprite){
		case spr_AU_Kira_THIF_Idle:
	        switch(_frame){
	            default: _x_pos = 74; _y_pos = 48; _rotation = 45; break;
	        }
	    break;
	    case spr_AU_Kira_THIF_Attack:
	        switch(_frame){
	            case 1: _x_pos = 19; _y_pos = 41; _rotation = 90; break;
				default:  _x_pos = 69; _y_pos = 33; _rotation = 45; break;
	        }
	    break;
		 case spr_AU_Kira_THIF_Ranged_Attack:
	        switch(_frame){
	            case 1: _x_pos = 33; _y_pos = 51; _rotation = 0; _hidden = true; break;
				default:  _x_pos = 43; _y_pos = 53; _rotation = 315; break;
	        }
	    break;
	    case spr_AU_Kira_THIF_Block:
	        switch(_frame){
	            default: _x_pos = 56; _y_pos = 30; _rotation = 315; break;
	        }
	    break;
		case spr_AU_Kira_THIF_Use_Item:
	        switch(_frame){
	            case 1: _x_pos = 67; _y_pos = 47; _rotation = 45; break;
				default:  _x_pos = 62; _y_pos = 46; _rotation = 90; break;
	        }
	    break;
