function Battle_Prop_Stats_AU_Blast_Whirlwind_Dark_02_Following(_stat){
	var _sprite = spr_AU_Blast_Whirlwind_Dark_02;
...
function Battle_Prop_Loop_Event_AU_Blast_Whirlwind_Dark_02_Following(_prop){
