...
//======================
function Town_Character_Stats_AU_Ciera(_character){
	with(_character){
...
//======================
function Get_Appearance_AU_Ciera(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Ciera_HEAL_Overworld; 
	var _portrait = spr_AU_Ciera_HEAL_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "AU_Ciera_HEAL";
...
function Get_Battle_Sprite_Stats_AU_Ciera_HEAL(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_AU_Ciera_HEAL_Attack; break;
		case "Block": _sprite = spr_AU_Ciera_HEAL_Block; break;
		case "Cast_Spell": _sprite = spr_AU_Ciera_HEAL_Cast_Spell; break;
		case "Use_Item": _sprite = spr_AU_Ciera_HEAL_Use_Item; break;
...
//===============================
function Get_Weapon_Position_AU_Ciera_HEAL(_object,_stat){
	...
	//=================
	switch(_sprite){
	    case spr_AU_Ciera_HEAL_Idle:
	        switch(_frame){
	            default: _x_pos = 78; _y_pos = 51; _rotation = 0; break;
	        }
	    break;
	    case spr_AU_Ciera_HEAL_Attack:
	        switch(_frame){
	            case 1: _x_pos = 28; _y_pos = 48; _rotation = 90; break;
				default:  _x_pos = 73; _y_pos = 43; _rotation = 0; break;
	        }
	    break;
	    case spr_AU_Ciera_HEAL_Block:
	        switch(_frame){
	            case 0: _x_pos = 65; _y_pos = 34; _rotation = 0; break;
	        }
	    break;
	    case spr_AU_Ciera_HEAL_Cast_Spell:
	        switch(_frame){
	            case 1: _x_pos = 40; _y_pos = 39; _rotation = 45; break;
				default:  _x_pos = 78; _y_pos = 23; _rotation = 270; break;
	        }
	    break;
		case spr_AU_Ciera_HEAL_Use_Item:
	        switch(_frame){
	            case 1: _x_pos = 79; _y_pos = 64; _rotation = 315; break;
				default:  _x_pos = 78; _y_pos = 51; _rotation = 0; break;
	        }
	    break;
