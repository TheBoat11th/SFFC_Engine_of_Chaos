function Chained_Animation(_character){
	if(_character.chained_animation = "Explode"){
	    ...
	    Sprite_Animation(_character,spr_Explode_Overworld,1,.125 / global.xspeed,true,true);
	    ...
	    _character.chained_animation = "none";
	    Sprite_Animation(_character,spr_Magic_Beam_Fade_Overworld,1,.25 / global.xspeed,true,true);
	}
	    ...
	    Sprite_Animation(_character,spr_Explode_Blue_Overworld,1,.125 / global.xspeed,true,true);
