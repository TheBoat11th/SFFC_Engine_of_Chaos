function Battle_Prop_Stats_AU_Blast_Whirlwind_Dark_01(_stat){
	var _sprite = spr_AU_Blast_Whirlwind_Dark_01;
...
function Battle_Prop_Loop_Event_AU_Blast_Whirlwind_Dark_01(_prop){
	with(_prop){
		x_pos = Wave(wave_x_center-10,wave_x_center+10,3,0);
	}
}