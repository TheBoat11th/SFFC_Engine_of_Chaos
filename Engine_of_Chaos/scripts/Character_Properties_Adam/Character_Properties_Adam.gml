...
//======================
function Town_Character_Stats_Adam(_character){
	with(_character){
...
//======================
function Get_Appearance_Adam(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Adam_CYBG_Overworld; 
	var _portrait = spr_Adam_CYBG_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Adam_CYBG";
...
function Get_Battle_Sprite_Stats_Adam_CYBG(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Adam_CYBG_Attack; break;
		case "Block": _sprite = spr_Adam_CYBG_Block; break;
		case "Use_Item": _sprite = spr_Adam_CYBG_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Adam_CYBG(_object,_stat){
