...
//======================
function Town_Character_Stats_Knuckles(_character){
	with(_character){
...
//======================
function Get_Appearance_Knuckles(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Knuckles_MONK_Overworld; 
	var _portrait = spr_Knuckles_MONK_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Knuckles_MONK";
...
function Get_Battle_Sprite_Stats_Knuckles_MONK(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Knuckles_MONK_Attack; break;
		case "Block": _sprite = spr_Knuckles_MONK_Block; break;
		case "Cast_Spell": _sprite = spr_Knuckles_MONK_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Knuckles_MONK_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Knuckles_MONK(_object,_stat){
