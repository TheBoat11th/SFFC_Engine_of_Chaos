...
//======================
function Town_Character_Stats_Elder(_character){
	with(_character){
...
//======================
function Get_Appearance_Elder(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Elder_Overworld; 
	var _portrait = spr_Elder_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Elder_OLD";
...
function Get_Battle_Sprite_Stats_Elder_OLD(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Elder_Attack; break;
		case "Block": _sprite = spr_Elder_Block; break;
		case "Use_Item": _sprite = spr_Elder_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Elder_OLD(_object,_stat){
