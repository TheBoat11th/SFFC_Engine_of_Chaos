function Battle_Prop_Stats_AU_Blast_Green_Wind_Explosion(_stat){
	var _sprite = spr_AU_Blast_Green_Wind_Explosion;
...
function Battle_Prop_Animation_Event_AU_Blast_Green_Wind_Explosion(_prop){
	with(_prop){
	    if(current_frame = 1){
