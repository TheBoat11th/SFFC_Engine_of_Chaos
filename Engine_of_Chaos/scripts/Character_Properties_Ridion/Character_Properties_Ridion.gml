...
//======================
function Town_Character_Stats_Ridion(_character){
	with(_character){
...
//======================
function Get_Appearance_Ridion(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Ridion_WARR_Overworld; 
	var _portrait = spr_Ridion_WARR_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Ridion_WARR";
	...
	switch(Get_Character_Class(_lookup_type,_character,"Abbreviation")){
		case "WARR": _overworld_sprite = spr_Generic_Chicken_Overworld; break;
	}
	//=====================
...
function Get_Battle_Sprite_Stats_Ridion_WARR(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Ridion_WARR_Attack; break;
		case "Block": _sprite = spr_Ridion_WARR_Block; break;
		case "Use_Item": _sprite = spr_Ridion_WARR_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Ridion_WARR(_object,_stat){
