function Town_Character_Stats_AU_Alpha_Wolf(_character){
	with(_character){
...
//======================
function Get_Appearance_AU_Alpha_Wolf(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Alpha_Wolf_Overworld;
	var _portrait = noone;
	var _voice = sfx_Dialogue07;
	var _battle_sprite = "AU_Alpha_Wolf";
...
function Get_Battle_Sprite_Stats_AU_Alpha_Wolf(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_AU_Alpha_Wolf_Attack; break;
		case "Block": _sprite = spr_AU_Alpha_Wolf_Block; break;
