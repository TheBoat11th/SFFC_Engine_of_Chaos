...
//======================
function Town_Character_Stats_Cynthia(_character){
	with(_character){
...
//======================
function Get_Appearance_Cynthia(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Cynthia_HEAL_Overworld; 
	var _portrait = spr_Cynthia_HEAL_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Cynthia_HEAL";
...
function Get_Battle_Sprite_Stats_Cynthia_HEAL(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Cynthia_HEAL_Attack; break;
		case "Block": _sprite = spr_Cynthia_HEAL_Block; break;
		case "Cast_Spell": _sprite = spr_Cynthia_HEAL_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Cynthia_HEAL_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Cynthia_HEAL(_object,_stat){
