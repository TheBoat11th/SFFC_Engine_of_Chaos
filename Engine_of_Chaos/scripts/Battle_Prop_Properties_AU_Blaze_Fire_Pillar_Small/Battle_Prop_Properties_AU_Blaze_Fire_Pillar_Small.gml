function Battle_Prop_Stats_AU_Blaze_Fire_Pillar_Small(_stat){
	var _sprite = spr_AU_Blaze_Fire_Pillar_Small;
...
function Battle_Prop_Animation_Event_AU_Blaze_Fire_Pillar_Small(_prop){
	with(_prop){
	    if(current_frame = 1){
