function Meeting_Max_Cutscene() {
	...
	switch(state){
	    ...
	    case 2: _message = (_jason.name + "!^ It's about time you got up!^ We're going to be late!"); break;
	...
	switch(state){
		case 0:
	        ...
	        if (global.FPS_Cap < 180) {Create_Character_Dialogue("Local",_max,_message,id,true,true);//portrait, voice, message,object,arrow,pan
			state += 1;	
			}
		break;
		case 2:
