...
//======================
function Town_Character_Stats_Paige(_character){
	with(_character){
...
//======================
function Get_Appearance_Paige(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Paige_SLDR_Overworld; 
	var _portrait = spr_Paige_SLDR_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Paige_SLDR";
...
function Get_Battle_Sprite_Stats_Paige_SLDR(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Paige_SLDR_Attack; break;
		case "Block": _sprite = spr_Paige_SLDR_Block; break;
		case "Use_Item": _sprite = spr_Paige_SLDR_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Paige_SLDR(_object,_stat){
