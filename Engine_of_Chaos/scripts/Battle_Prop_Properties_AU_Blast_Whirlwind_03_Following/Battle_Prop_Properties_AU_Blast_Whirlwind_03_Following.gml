function Battle_Prop_Stats_AU_Blast_Whirlwind_03_Following(_stat){
	var _sprite = spr_AU_Blast_Whirlwind_03;
...
function Battle_Prop_Loop_Event_AU_Blast_Whirlwind_03_Following(_prop){
