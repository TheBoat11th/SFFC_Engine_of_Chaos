...
//======================
function Town_Character_Stats_AU_Karina(_character){
	with(_character){
		Set_Town_Party_Member_Stats(4);
	}
}
...
//======================
function Get_Appearance_AU_Karina(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Karina_MAGE_Overworld; 
	var _portrait = spr_AU_Karina_MAGE_Portrait;
	var _voice = sfx_Dialogue04;
	var _battle_sprite = "AU_Karina_MAGE";
...
function Get_Battle_Sprite_Stats_AU_Karina_MAGE(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_AU_Karina_MAGE_Attack; break;
		case "Block": _sprite = spr_AU_Karina_MAGE_Block; break;
		case "Cast_Spell": _sprite = spr_AU_Karina_MAGE_Cast_Spell; break;
		case "Use_Item": _sprite = spr_AU_Karina_MAGE_Use_Item; break;
...
//===============================
function Get_Weapon_Position_AU_Karina_MAGE(_object,_stat){
	...
	//=================
	switch(_sprite){
	    case spr_AU_Karina_MAGE_Idle:
	        switch(_frame){
	            default: _x_pos = 90; _y_pos = 58; _rotation = 315; break;
	        }
	    break;
	    case spr_AU_Karina_MAGE_Attack:
	        switch(_frame){
	            case 1: _x_pos = 36; _y_pos = 54; _rotation = 90; break;
				default:  _x_pos = 88; _y_pos = 29; _rotation = 270; break;
	        }
	    break;
	    case spr_AU_Karina_MAGE_Block:
	        switch(_frame){
	            case 0: _x_pos = 49; _y_pos = 40; _rotation = 45; break;
	        }
	    break;
	    case spr_AU_Karina_MAGE_Cast_Spell:
	        switch(_frame){
	            case 1: _x_pos = 25; _y_pos = 45; _rotation = 90; break;
				default:  _x_pos = 86; _y_pos = 30; _rotation = 315; break;
	        }
	    break;
		case spr_AU_Karina_MAGE_Use_Item:
	        switch(_frame){
	            case 1: _x_pos = 76; _y_pos = 66; _rotation = 315; break;
				default:  _x_pos = 76; _y_pos = 54; _rotation = 315; break;
	        }
	    break;
