...
//======================
function Town_Character_Stats_Magus(_character){
	with(_character){
...
//======================
function Get_Appearance_Magus(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Magus_GDVL_Overworld; 
	var _portrait = spr_Magus_GDVL_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Magus";
...
function Get_Battle_Sprite_Stats_Magus(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Magus_Attack; break;
		case "Block": _sprite = spr_Magus_Block; break;
		case "Cast_Spell": _sprite = spr_Magus_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Magus_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Magus(_object,_stat){
