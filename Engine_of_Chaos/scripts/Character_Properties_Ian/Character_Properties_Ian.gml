...
//======================
function Town_Character_Stats_Ian(_character){
	with(_character){
...
//======================
function Get_Appearance_Ian(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Ian_SDMN_Overworld; 
	var _portrait = spr_Ian_SDMN_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Ian_SDMN";
...
function Get_Battle_Sprite_Stats_Ian_SDMN(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Ian_SDMN_Attack; break;
		case "Block": _sprite = spr_Ian_SDMN_Block; break;
		case "Use_Item": _sprite = spr_Ian_SDMN_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Ian_SDMN(_object,_stat){
