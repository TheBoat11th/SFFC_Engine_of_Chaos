...
//======================
function Town_Character_Stats_AU_Jason(_character){
	with(_character){
...
//======================
function Get_Appearance_AU_Jason(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_AU_Jason_SDMN_Overworld; 
	var _portrait = spr_AU_Jason_SDMN_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "AU_Jason_SDMN";
...
function Get_Battle_Sprite_Stats_AU_Jason_SDMN(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_AU_Jason_SDMN_Attack; break;
		case "Block": _sprite = spr_AU_Jason_SDMN_Block; break;
		case "Use_Item": _sprite = spr_AU_Jason_SDMN_Use_Item; break;
...
//===============================
function Get_Weapon_Position_AU_Jason_SDMN(_object,_stat){
