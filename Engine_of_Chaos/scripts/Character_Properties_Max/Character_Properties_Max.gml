...
//======================
function Get_Appearance_Max(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Max_HERO_Overworld; 
	var _portrait = spr_Max_HERO_Portrait;
	var _voice = sfx_Dialogue05;
	var _battle_sprite = "Max_HERO";
...
function Get_Battle_Sprite_Stats_Max_HERO(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Max_HERO_Attack; break;
		case "Block": _sprite = spr_Max_HERO_Block; break;
		case "Use_Item": _sprite = spr_Max_HERO_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Max_HERO(_object,_stat){
