...
//======================
function Town_Character_Stats_Goblin(_character){
	with(_character){
...
//======================
function Get_Appearance_Goblin(_lookup_type,_character,_stat){
	var _overworld_sprite = spr_Goblin_Overworld; 
	var _portrait = spr_Goblin_Portrait;
	var _voice = sfx_Dialogue03;
	var _battle_sprite = "Goblin";
...
function Get_Battle_Sprite_Stats_Goblin(_animation,_stat){
	...
	//===================
	switch(_animation){
		case "Melee_Attack": _sprite = spr_Goblin_Attack; break;
		case "Block": _sprite = spr_Goblin_Block; break;
		case "Cast_Spell": _sprite = spr_Goblin_Cast_Spell; break;
		case "Use_Item": _sprite = spr_Goblin_Use_Item; break;
...
//===============================
function Get_Weapon_Position_Goblin(_object,_stat){
